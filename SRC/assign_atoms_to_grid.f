...
c     do iii=1,num_tot_atms
      do iii=1,num_mov_atms ! 2019 - only use moving atoms
...
C make sure that the limits are correctly applied:
        ...
        i2_lic(iii)=i2
        i3_lic(iii)=i3
        cll_f_1(i1,i2,i3,i4)%num=cll_f_1(i1,i2,i3,i4)%num+1
      ...
      do i3=1,num_z_ff
        do i2=1,num_y_ff
          do i1=1,num_x_ff
            deallocate(cll_f_1(i1,i2,i3,i4)%ida)
          enddo
        enddo
      enddo
      ...
      do i3=1,num_z_ff
        do i2=1,num_y_ff
          do i1=1,num_x_ff
            allocate(cll_f_1(i1,i2,i3,i4)%ida
     &              (cll_f_1(i1,i2,i3,i4)%num))
          enddo
        enddo
      enddo
...
c     do iii=1,num_tot_atms
      do iii=1,num_mov_atms ! 2019 - only use moving atoms
        cll_f_1(i1_lic(iii),i2_lic(iii),i3_lic(iii),i4)%num=
     &  cll_f_1(i1_lic(iii),i2_lic(iii),i3_lic(iii),i4)%num+1
        cll_f_1(i1_lic(iii),i2_lic(iii),i3_lic(iii),i4)%ida
     & (cll_f_1(i1_lic(iii),i2_lic(iii),i3_lic(iii),i4)%num)=iii
      enddo                                           
